...
import Offcanvas from "./LecturerOffcanvas";
import '../Homepage.css'
...
function ProjectSupervising () {
    ...
    return (
        <>
          ...
          <div className="main">
          <div>  
                { isProfileOpen && <LecturerProfileModal onClose={ () =>  setIsLogoutOpen(false)} />       
                }    
                { isLogoutOpen && (
                                            <>
...
export default ProjectSupervising;
